...
class BudgetItem(BaseModel):
	...
	Attributes:
		...
		nombre_paquete: Nombre del paquete al que pertenece
		items_incluidos: Lista de items incluidos en el paquete
	...
	items_incluidos: list[str] = Field(
	...
	def to_dict_pdf(self) -> dict:
		...
		return {
			...
			"items_incluidos": self.items_incluidos if self.items_incluidos else [],
		}
