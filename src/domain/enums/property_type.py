...
class PropertyType(str, Enum):
    ...
    @property
    def es_vivienda_habitual(self) -> bool:
        """
        Indica si el tipo de inmueble puede ser vivienda habitual.
        
        Esto afecta al IVA aplicable (10% vs 21%).
        """
        return self in (self.PISO, self.VIVIENDA)
    
    @property
    def iva_aplicable(self) -> float:
        """
        Porcentaje de IVA aplicable según el tipo de inmueble.
        
        Returns:
            float: 10.0 para vivienda habitual, 21.0 para otros
        """
        return 10.0 if self.es_vivienda_habitual else 21.0
