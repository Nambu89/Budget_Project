...
class PricingService:
    ...
    def crear_partidas_paquete(
        ...
        # Crear una única partida representando el paquete completo
        codigo = f"PKG-{paquete[:8].upper()}"
        
        # Obtener lista completa de items incluidos
        items_incluidos = info.get('incluye', [])
        ...
        return [
            {
                ...
                "incluye": PACKAGES_DATA[paq]["incluye"],
            }
