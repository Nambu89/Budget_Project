...
class DataCollectorAgent:
    ...
    def __init__(self):
        ...
        self.agent = Agent(
            ...
            goal="Validar y estructurar los datos del proyecto de reforma",
            backstory="""
        ...
        logger.info("✓ DataCollectorAgent inicializado")
    ...
    def procesar_formulario(self, datos: dict) -> dict:
        ...
        # Validar vivienda habitual (opcional, default: False)
        if "es_vivienda_habitual" in datos:
            resultado["proyecto"]["es_vivienda_habitual"] = bool(datos["es_vivienda_habitual"])
        else:
            resultado["proyecto"]["es_vivienda_habitual"] = False
    ...
    def generar_resumen(self, resultado: dict) -> str:
        ...
        if proyecto.get("es_vivienda_habitual"):
            lineas.append("🏡 Vivienda habitual: Sí (IVA reducido 10%)")
        else:
            lineas.append("🏢 Vivienda habitual: No (IVA general 21%)")
